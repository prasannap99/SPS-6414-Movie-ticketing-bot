# SPS-6414-Movie-ticketing-bot
Movie ticketing bot
# hydrabada_Movie_Booking_Bot
This sample chat bot displays theaters list in hydrabada and allows users to book the tickets online..
...
2) Check for: @hydrabada-cinema <br>
   Save it as: $movielocation  <br>
   If not present, ask: Please enter the location of your preference in hydrabada
...
2.  Select the file called *Hydrabada_Movie_Booking_Bot.json*, which can be found in this repository.
